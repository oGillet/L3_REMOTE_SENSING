...
Au final, il me faut 5 minutes pour écrire le script R et 5 pour découper 20 images satellitaires situées dans 4 répertoires différents. Ce prétraitement vous permet de manipuler des objets moins lourds pour votre machine.  
...
# 5 - Etude de la végétation `r emo::ji("calculation")`
...
# 6 - Etude des sols `r emo::ji("calculation")`
...
# 7 - Etude des surfaces hygrophiles `r emo::ji("calculation")`
...
`r emo::ji("question")` Vous devez tracer l'évolution des NDVI et du BSI  sur 4/5 points différents de la zone d'étude.
