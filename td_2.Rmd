...
df <- data.frame(Date=c(rep(as.Date(c("10/14/2017"),"%m/%d/%y"),8)),  
                 Superficie=c(1.280/7.27,2.266/49.51 ,1.683/12.08,2.79/18.98,5.756/44.13,0.199/6.43,4.888/46.83,4.074/33.14),
                 Commune=c("Bohars","Brest","Gouesnou","Guilers","Guipavas","Le Relecq-Kerhuon","Plougastel-Daoulas","Plouzané"))

p <- ggplot2::ggplot(df, ggplot2::aes(x=Commune, y=Superficie, fill=Commune)) +
  ggplot2::geom_bar(stat="identity")+
  ggplot2::labs(title = "Proportion des espaces végétalisés par communes",subtitle = "10 octobre 2017 - Seuil fixé à 0.5", x="Commune", y="Pourcentage (%)")+ 
